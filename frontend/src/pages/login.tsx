...
//           <input className="w-full p-2 border rounded text-gray-700" type="email" placeholder="Email" value={email} onChange={(e)=>setEmail(e.target.value)} />
//           <input className="w-full p-2 border rounded text-gray-700" type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
//           <button className="w-full bg-indigo-600 text-white p-2 rounded hover:bg-indigo-700" type='submit'>Login</button>
//         </form>
//       </div>
//     </main>
//   );
