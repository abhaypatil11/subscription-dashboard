...
// //             <h2 className="text-lg font-semibold mb-2">Total Monthly Spend</h2>
...
// //           {/* <div className="bg-white p-4 rounded shadow">
// //             <h2 className="text-lg font-semibold mb-2">Redundancy Alerts</h2>
// //             <p className="text-sm">
// //               You have 3 subscriptions in "Entertainment".
// //             </p>
// //           </div> */}
// //           <div className="bg-white p-4 rounded shadow">
// //             <h2 className="text-lg font-semibold mb-2">Redundancy Alerts</h2>
...
// //                 <li>No redundancy detected. You're all good!</li>
// //               )}
// //             </ul>
// //           </div>
// //         </aside>
...
//   return (
//     <main className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 text-gray-800">
//       <header className="bg-white/90 shadow px-6 py-4 flex justify-between items-center sticky top-0 z-10 backdrop-blur">
...
//               {getRedundancyAlerts(subscriptions).map(([category, count]) => (
//                 <li key={category}>
//                   You have {count} subscriptions in{" "}
//                   <strong className="text-rose-600">{category}</strong>.
//                 </li>
//               ))}
//               {getRedundancyAlerts(subscriptions).length === 0 && (
