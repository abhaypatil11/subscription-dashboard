...
// import withAuth from '../../utils/withAuth'; // Ensure you have this HOC to protect the route
...
//       try {
//         const res = await API.get(`/subscriptions`, { params: { userId: 'your-user-id' } }); // temp workaround if you don't have a single fetch endpoint
...
//         <h2 className="text-xl font-semibold mb-4 text-black">Edit Subscription</h2>
//         <form className="space-y-4" onSubmit={handleSubmit}>
//           <input className="w-full p-2 border rounded text-gray-800" type="text" placeholder="Service Name"
//             value={form.serviceName} onChange={(e) => setForm({ ...form, serviceName: e.target.value })} />
//           <input className="w-full p-2 border rounded text-gray-800" type="number" placeholder="Cost"
...
//           </select>
//           <input className="w-full p-2 border rounded text-gray-800" type="date"
//             value={form.nextBillingDate} onChange={(e) => setForm({ ...form, nextBillingDate: e.target.value })} />
//           <input className="w-full p-2 border rounded text-gray-800" type="text" placeholder="Category"
...
// File: src/pages/edit-subscription/[id].tsx
import { useRouter } from 'next/router';
import { useEffect, useState } from 'react';
