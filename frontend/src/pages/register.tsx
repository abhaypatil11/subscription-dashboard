...
//           <input className="w-full p-2 border rounded text-gray-700" type="text" placeholder="Name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
//           <input className="w-full p-2 border rounded text-gray-700" type="email" placeholder="Email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
//           <input className="w-full p-2 border rounded text-gray-700" type="password" placeholder="Password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} />
//           <button className="w-full bg-indigo-600 text-white p-2 rounded hover:bg-indigo-700" type='submit'>Register</button>
//         </form>
//       </div>
//     </main>
//   );
